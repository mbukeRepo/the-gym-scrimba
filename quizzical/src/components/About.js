  ...
  <div className="modal__content">
    ...
    <article>
      ...
      <p>
        ...
        <a href="https://opentdb.com/">Open Trivia Database API</a>, a database
        of freely available questions to use for programmers.
      </p>
    </article>
    <article>
      <h3>Who made Quizzical?</h3>
      <p>
        Hi! I’m Mbuke Price, a web developer 👋. You can check more of my work{" "}
        <a href="https://github.com/mbukeRepo">here</a>.
      </p>
    </article>
  </div>
);
